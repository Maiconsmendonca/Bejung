...
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	respostas.JSON(w, http.StatusInternalServerError, usuario)
...
func SeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorID == usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não è possível seguir você mesmo"))
	}
...
//BuscarSeguidores permite que um usuário siga outro
